...
use App\Lib\reportes\easytable\exFPDF;



class FpdfSicaf extends exFPDF
{
    ...
    protected $oficio = [220, 330];


    public $imprimirEncabezado = true;

    public $imprimirFooter = true;
    public $setterDasher = false;
    ...
    public function footer()
    {
        ...
        if ($this->imprimirFooter) {

            $this->SetY(-10);
            $this->SetFont('Arial', 'I', 7);
            $this->Cell(150, 6, utf8Decode(config('app.constants.name_full')), 0, 0, "R");

            $this->SetY(-10);
            $this->Cell(0, 6, utf8Decode('Página') . " " . $this->PageNo(). ' de  {nb}' , 0, 0, "R");
        }
    }
    ...
    public function encabezado($img = array())
    {
        ...
        $m = $this->medidas();
        $this->Image('../public/assets/img/logo-upea.png', 20, 3, 15, 'jpg');
    ...
    function AjustMultiCell($width, $data, $w, $h = 0, $txt = '', $border = 0, $align = '')
    {
