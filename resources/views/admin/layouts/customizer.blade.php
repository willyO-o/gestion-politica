...
<div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
    ...
    <div class="offcanvas-body p-0">
        <div data-simplebar class="h-100">
            <div class="p-4">
                <h6 class="mb-0 fw-semibold text-uppercase fs-12">Disposición</h6>
                ...
                <h6 class="mt-4 mb-0 fw-semibold text-uppercase fs-12">Esquema de colores</h6>
                <p class="text-muted">Elija un esquema claro u oscuro.</p>
                ...
                <div class="colorscheme-cardradio">
                    <div class="row">
                        <div class="col-4">
                            ...
                            <h5 class="fs-13 text-center mt-2">Ligero</h5>
                        </div>
                ...
                <div id="layout-width">
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <h5 class="fs-13 text-center mt-2">Líquido</h5>
                        </div>
                        <div class="col-4">
                            <div class="form-check card-radio">
                ...
                <div id="layout-position">
                    ...
                    <p class="text-muted">Elija una posición de diseño fija o desplazable.</p>
                ...
                <h6 class="mt-4 mb-0 fw-semibold text-uppercase fs-12">Color de la barra superior</h6>
                <p class="text-muted">
                    Elija el color de la barra superior claro u oscuro.</p>
                ...
                <div id="sidebar-size">
                    <h6 class="mt-4 mb-0 fw-semibold text-uppercase fs-12">Tamaño de la barra lateral</h6>
                ...
                <div id="sidebar-view">
                    <h6 class="mt-4 mb-0 fw-semibold text-uppercase fs-12">Vista de la barra lateral</h6>
                ...
                <div id="sidebar-color">
                    <h6 class="mt-4 mb-0 fw-semibold text-uppercase fs-12">Color de la barra lateral</h6>
                ...
                <div id="sidebar-img">
                    <h6 class="mt-4 mb-0 fw-semibold text-uppercase fs-12">Imágenes de la barra lateral</h6>
                    <p class="text-muted">Elige una imagen de la barra lateral.</p>
                    ...
                    <div class="d-flex gap-2 flex-wrap img-switch">
                        ...
                        <div class="form-check sidebar-setting card-radio">
                            <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-05" value="img-5">
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-05">
                                <img src="/assets/images/sidebar/img-5.jpg" alt="" class="avatar-md w-auto object-cover">
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div id="preloader-menu">
                    <h6 class="mt-4 mb-0 fw-semibold text-uppercase fs-12">Precargador</h6>
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <h5 class="fs-13 text-center mt-2">Activar</h5>
                        </div>
                        <div class="col-4">
                            <div class="form-check sidebar-setting card-radio">
                            ...
                            <h5 class="fs-13 text-center mt-2">Desactivar</h5>
                        </div>
                    </div>
