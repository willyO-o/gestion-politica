@section('content')
                ...
                <div class="card-body ">
                    <div>
                        <div class="table-responsive table-card  overflow-auto scroll-style" style="height: 65vh;"
                            id="containerListaSeguimiento">
                            <table class="table align-middle table-wrap table-sm  mb-0" id="tablaInscripcion">
                                <thead class="table-light sticky-top top-0 z-index-10 ">
                                    <tr>
                                        ...
                                        <th data-sort="seguimiento" scope="col">Seguimientos</th>

                                        <th scope="col">Acciones</th>
                                    </tr>
                                </thead>
                                <tbody class="small" id="tbodyListaSeguimiento">
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            ...
                                            <input type="date" class="form-control" id="fecha_inicio"
                                                ...
                                                min="{{ date('Y-m-d', strtotime('-5 month')) }}" />
    ...
    <div class="modal fade" id="modalAddSeguimiento" tabindex="-1" aria-labelledby="t" aria-hidden="true"
        data-bs-backdrop="static" data-bs-keyboard="false" data-bs-focus="false">
        <div class="modal-dialog modal-dialog-centered modal-lg modal-xl">
            <div class="modal-content border-0">
                <div class="modal-header bg-soft-secondary p-3">
                    <h5 class="modal-title">Nuevo Seguimiento de la Inscripción Nro.: <span id="tituloModalPago"
                            class="text-danger"></span></h5>
                    <button type="button" class="btn-close cancel-btn-photo" data-bs-dismiss="modal" aria-label="Close"
                        id="btn-cancel-pay-x"></button>
                </div>
                <form id="formSeguimiento" action="#" novalidate method="POST"
                    onkeydown="return event.key != 'Enter';">
                    <div class="modal-body bg-light mb-0 pb-0" id="listadoSeguimientos">

                        <div class="card ">

                            <input type="hidden" id="id_inscripcion_pago" name="id_inscripcion_fk" value="" />
                            <input type="hidden" id="id_seguimiento" value="" />
                            <input type="hidden" id="actionSeguimiento" value="registrar" />

                            <div class="card-body">
                                <h4 class="card-title text-center" id="actionTitleSeguimiento">Registrar Seguimiento</h4>
                                <div class="row mb-2">
                                    <div class="col-md-12 d-flex align-items-center">

                                        <div class="flex-shrink-0 me-2">
                                            <div class="bg-light p-1"> <img
                                                    src="{{ url('/assets/images/users/user-dummy-img.jpg') }}"
                                                    alt="" class="avatar-lg  rounded" id="fotoEstudiante"> </div>
                                        </div>
                                        <div class="flex-grow-1 ms-2">
                                            <label for="datosInscripcionPago" class="form-label">Datos de
                                                Inscripción</label>
                                            <div type="text" class="form-control form-control-sm bg-light"
                                                id="datosInscripcionPago" disabled></div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-lg-3">
                                        <div>
                                            <label for="fecha_valoracion" class="form-label">Fecha del Seguimiento <small
                                                    class="text-danger">*</small> </label>

                                            <input type="date" class="form-control form-control-sm"
                                                id="fecha_valoracion" name="fecha_valoracion" required
                                                max="{{ date('Y-m-d') }}" value="{{ date('Y-m-d') }}" />

                                            <div class="invalid-feedback">
                                                Por favor ingrese la fecha que se realizo el seguimiento.
                                            </div>
                                    ...
                                    <div class="col-md-4 col-lg-3">
                                        <div class="mt-1">
                                            <label for="puesto" class="form-label">Puesto <small
                                                    class="text-danger">*</small> </label>
                                            <input type="text" id="puesto" name="puesto"
                                                class="form-control form-control-sm max-length " maxlength="100" required
                                                placeholder=" " />
                                            <div class="invalid-feedback">
                                                Por favor ingrese el puesto que ocupa el estudiante.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-lg-3">
                                        <div class="mt-1">
                                            <label for="dorsal" class="form-label">Dorsal <small
                                                    class="text-danger">*</small> </label>
                                            <input type="text" id="dorsal" name="dorsal"
                                                class="form-control form-control-sm max-length txtNumero" maxlength="3"
                                                required placeholder="" />
                                            <div class="invalid-feedback">
                                                Por favor ingrese el dorsal que ocupa el estudiante.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-lg-3">
                                        <div class="mt-1">
                                            <label for="altura" class="form-label">Altura del Estudiante <small
                                                    class="text-muted">[metros] </small> </label>
                                            <input type="text" id="altura" name="altura"
                                                class="form-control form-control-sm max-length txtDecimal" maxlength="4"
                                                placeholder=" ejemplo: 1.64" />
                                            <div class="invalid-feedback">
                                                Por favor ingrese la altura del estudiante.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-lg-3">
                                        <div class="mt-1">
                                            <label for="peso" class="form-label">Peso del Estudiante <small
                                                    class="text-muted">[kilogramos] </small> </label>
                                            <input type="text" id="peso" name="peso"
                                                class="form-control form-control-sm max-length txtDecimal" maxlength="6"
                                                placeholder=" " />
                                            <div class="invalid-feedback">
                                                Por favor ingrese el peso del estudiante.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-lg-3">
                                        <div class="mt-1">
                                            <label for="" class="form-label">Pierna Dominante <small
                                                    class="text-danger">*</small> </label> <br>
                                            <div class="form-check form-check-inline form-radio-primary mb-0">
                                                <input class="form-check-input" type="radio" name="pierna"
                                                    value="DIESTRO" id="pierna_diestro" required>
                                                <label class="form-check-label" for="pierna_diestro">
                                                    Diestro
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline form-radio-primary mb-1">
                                                <input class="form-check-input" type="radio" name="pierna"
                                                    value="ZURDO" id="pierna_zurdo" required>
                                                <label class="form-check-label" for="pierna_zurdo">
                                                    Zurdo
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline form-radio-primary mb-1">
                                                <input class="form-check-input" type="radio" name="pierna"
                                                    value="AMBIDIESTRO" id="pierna_ambidiestro" required>
                                                <label class="form-check-label" for="pierna_ambidiestro">
                                                    Ambidiestro
                                                </label>
                        ...
                        <div class="card mb-1">
                            <div class="card-header border border-top py-2">
                                <h4 class="card-title mb-0 text-center">Valoración</h4>

                            </div>

                            <div class="card-body ">

                                <div id="containerCaracteristicas" class="table-responsive">
                        ...
                        <div class="modal-footer mt-4">
                            <div class="hstack gap-2 justify-content-end">
                                <button type="reset" class="btn btn-light" data-bs-dismiss="modal"
                                    id="cancel-btn">Cancelar</button>
                                <button type="submit" class="btn btn-success mdi" id="btn-add-seguimiento">Registrar
                                    Seguimiento</button>
    ...
    <div class="modal fade" id="modalListadoSeguimientos" tabindex="-1" aria-labelledby="t" aria-hidden="true"
        data-bs-backdrop="static" data-bs-keyboard="false" data-bs-focus="false">
        <div class="modal-dialog modal-dialog-centered   modal-fullscreen">
            <div class="modal-content border-0">
                <div class="modal-header bg-soft-secondary p-3">
                    <h5 class="modal-title">Seguimientos de la Inscripción Nro.: <span id="tituloModalListadoSeguimiento"
                            class="text-danger"></span></h5>
                ...
                <div class="modal-body bg-light mb-0 pb-0" id="listadoSeguimientos">
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body">
                            <h4 class="card-title text-center" id="actionTitleViewSeguimiento">Datos del Inscrito</h4>
                            <div  class="row">

                                <div class="col-md-6" id="datosSeguimientosInscrito">

                                </div>
                                <div class="col-md-6" id="datosSeguimientoGrupo">
                    ...
                    <div class="card mb-1">
                        <div class="card-header border border-top">
                            <div class="row">
                                <div class="col-md-6 col-lg-6">
                                    <h5 class="card-title">Listado de Seguimientos</h5>
                                </div>


                                <div class="col-lg-6 text-end">
                                    <input type="hidden" id="id_inscripcion_seguimiento" value="" />
                                    <button type="button" class="btn btn-sm btn-danger" id="btnPdfSeguimientos" disabled>
                        ...
                        <div class="card-body ">
                            <div class="table-responsive table-card  overflow-auto scroll-style" style="height: 40vh;"
                                id="containerListaSeguimientosInscripcion">
                                <table class="table align-middle table-wrap table-sm  mb-0" id="tablaSeguimientosInscripcion">
                                    <thead class="table-light sticky-top top-0 z-index-10 ">
                                        <tr>
                                            <th data-sort="nombre" scope="col">#</th>
                                            <th data-sort="nombre" scope="col">Nro. Valoración</th>
                                            <th data-sort="nombre" scope="col">Fecha de Valoración</th>
                                            <th data-sort="ci" scope="col"> Puesto</th>
                                            <th data-sort="celular" scope="col">Dorsal</th>
                                            <th data-sort="oficina" scope="col">Altura</th>
                                            <th data-sort="tipoPersonal" scope="col"> Peso </th>
                                            <th data-sort="tipoPersonal" scope="col"> Pierna Dominante </th>
                                            <th scope="col">Acciones</th>
                                        </tr>
                                    </thead>
                                    <tbody class="small" id="tbodyListaSeguimientos">
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body">
                            <h4 class="card-title text-center" id="valoracion">Valoraciones</h4>
                            <div  class="table-responsive" id="divContainerValoracion">
                                <fieldset id="containerValoracion">
