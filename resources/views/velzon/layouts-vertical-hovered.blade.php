                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="/assets/images/svg/crypto-icons/btc.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid shadow" alt="">
                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="/assets/images/svg/crypto-icons/ltc.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid shadow" alt="">
                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="/assets/images/svg/crypto-icons/etc.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid shadow" alt="">
                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="/assets/images/svg/crypto-icons/bnb.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid shadow" alt="">
                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="/assets/images/svg/crypto-icons/dash.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid shadow" alt="">
                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="/assets/images/svg/crypto-icons/usdt.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid shadow" alt="">
                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="/assets/images/svg/crypto-icons/neo.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid shadow" alt="">
            ...
            <div class="card-header align-items-center d-flex">
                ...
                <div class="flex-shrink-0 ms-2">
                    <div class="dropdown card-header-dropdown">
                        <a class="btn btn-soft-primary btn-sm shadow-none" role="button" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <table class="table table-hover table-borderless table-centered align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>$53,914.025</td>
                                <td>1.25634801</td>
                                <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary shadow-none">Trade</a>
                                </td>
                            </tr><!-- end -->
                            <tr>
                                <td>
                                ...
                                <td>$75,854.127</td>
                                <td>2.85472161</td>
                                <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary shadow-none">Trade</a></td>
                            </tr><!-- end -->
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <img src="/assets/images/svg/crypto-icons/bnb.svg" alt="" class="avatar-xxs shadow rounded-circle">
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <img src="/assets/images/svg/crypto-icons/usdt.svg" alt="" class="avatar-xxs shadow rounded-circle">
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <img src="/assets/images/svg/crypto-icons/doge.svg" alt="" class="avatar-xxs shadow rounded-circle">
                                        </div>
                                        <div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex align-middle">
                    <div class="flex-shrink-0">
                        <img src="/assets/images/small/img-1.jpg" class="rounded img-fluid shadow" style="height: 60px;" alt="">
                    </div>
                    <div class="flex-grow-1 ms-3">
                ...
                <div class="d-flex mt-4">
                    <div class="flex-shrink-0">
                        <img src="/assets/images/small/img-2.jpg" class="rounded img-fluid shadow" style="height: 60px;" alt="">
                    </div>
                    <div class="flex-grow-1 ms-3">
                ...
                <div class="d-flex mt-4">
                    <div class="flex-shrink-0">
                        <img src="/assets/images/small/img-3.jpg" class="rounded img-fluid shadow" style="height: 60px;" alt="">
                    </div>
                    <div class="flex-grow-1 ms-3">
                ...
                <div class="d-flex mt-4">
                    <div class="flex-shrink-0">
                        <img src="/assets/images/small/img-6.jpg" class="rounded img-fluid shadow" style="height: 60px;" alt="">
                    </div>
                    <div class="flex-grow-1 ms-3">
