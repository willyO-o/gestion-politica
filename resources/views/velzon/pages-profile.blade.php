...
<head>
     ...
     {{ view('velzon.partials.title-meta', array('title' => 'Profile')) }} 
                                                                                            ...
                                                                                            <div class="row mt-2">
                                                                                                <div class="col-xxl-6">
                                                                                                    <div class="row border border-dashed gx-2 p-2 shadow">
                                                                                                        ...
                                                                                                        <!--end col-->
                                                                                                        <div class="col-3">
                                                                                                            <img src="/assets/images/small/img-7.jpg" alt="" class="img-fluid rounded shadow" />
                                                                                                        </div>
                                                                                                        <!--end col-->
                                                                                                        <div class="col-3">
                                                                                                            <img src="/assets/images/small/img-9.jpg" alt="" class="img-fluid rounded shadow" />
                                                                                                        </div>
                                                                                                        <!--end col-->
                                                                                                    </div>
                                                                                                    <!--end row-->
